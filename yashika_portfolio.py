...
!ngrok config add-authtoken 2lLmzilNp7G6o5UAKkXnAXKdPSb_5dG8ayyJF6zyLdMSWpom6

import subprocess
import time

# Run the Streamlit app
process = subprocess.Popen(["streamlit", "run", "yashika_portfolio.py"])
time.sleep(5)  # Give it time to start

from pyngrok import ngrok

# Optional: authenticate ngrok once
